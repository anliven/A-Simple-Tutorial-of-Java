...
public class T08CreateObject {
	...
	public static void main(String[] args) {
		new T08CreateObject(); // 使用new关键字调用构造方法创建对象

		T08CreateObject test = new T08CreateObject();
		// ACreateObject --- 类
		// test --- 对象实体的引用（只是存放一个对象的内存地址）
		// new ACreateObject("hello") --- 对象实体
		System.out.println(test.getStr());
		System.out.println(new T08CreateObject().getStr());
