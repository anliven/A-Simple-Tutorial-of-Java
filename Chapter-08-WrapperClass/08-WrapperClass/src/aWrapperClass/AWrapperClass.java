...
public class AWrapperClass {
	...
	public static void main(String args[]) {
		...
		System.out.println("b1：" + b1.booleanValue());  //将此 Boolean 对象的值作为基本布尔值返回
		...
		System.out.println(mychar2 + "是小写字母吗? "
				+ Character.isLowerCase(mychar2));  //判断是否为小写字母
	}
...
### Number类
- 抽象类Number是 BigDecimal、BigInteger、Byte、Double、Float、Integer、Long 和 Short 类的超类（父类）。
- Number的子类必须提供将表示的数值转换为 byte、double、float、int、long 和 short 的方法。
...
- 更详细信息可以查看JDK API文档：软件包java.lang---》类Integer
